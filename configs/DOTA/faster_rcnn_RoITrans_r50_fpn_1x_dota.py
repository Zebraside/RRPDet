...
data_root = '/home/kmolchan/Development/Exp2/Data/'
train_data = 'Train/trainval1024/images'
train_ann = 'Train/trainval1024/DOTA_trainval1024.json'
test_data = 'Train/test1024/images'
test_ann = 'Train/test1024/DOTA_test1024.json'
...
load_from = None
resume_from = None # '/home/kmolchan/Development/Exp2/AerialDetection/tools/work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota/latest.pth'
workflow = [('train', 1)]
